...
const bancoDePreguntas = [
  {
    "cat": "Laboratorio",
    "p": "Un cliente pide un tubo para sangre completa (hematología). ¿Cuál le das?",
    "o": [
      "Tubo rojo con activador de coágulo",
      "Tubo amarillo con gel separador",
      "Tubo morado con EDTA"
    ],
    "c": 2,
    "e": "¡Correcto! El morado lleva EDTA y evita que la sangre se coagule para contar las células.",
    "curioso": "El EDTA es tan efectivo que se usa desde 1950 para análisis sanguíneos sin alterar la forma de las células."
  },
  {
    "cat": "Urgencias",
    "p": "Un doctor busca una aguja verde para una emergencia. ¿Qué número de catéter es?",
    "o": [
      "Catéter número 24 (amarillo)",
      "Catéter número 18 (verde)",
      "Catéter número 14 (naranja)"
    ],
    "c": 1,
    "e": "¡Correcto! El 18 es verde. A menor número, más gruesa la aguja: pasa líquidos más rápido.",
  ...
  {
    "cat": "Laboratorio",
    "p": "¿Para qué sirve el recolector de orina de 24 horas?",
    "o": [
      "Juntar toda la orina del paciente en un día",
      "Guardar orina de un bebé recién nacido",
      "Tomar una muestra rápida de cinco minutos"
    ],
    "c": 0,
    "e": "¡Correcto! Se recolecta la orina de todo el día para análisis más completos.",
    "curioso": "Se usa para medir sustancias como proteínas o creatinina que cambian mucho a lo largo del día."
  },
  {
    "cat": "Laboratorio",
    "p": "¿Qué hace el 'tubo con activador' (tubo rojo)?",
    "o": [
      "Evita que la sangre se coagule",
      "Diluye la muestra con agua estéril",
      "Acelera el coágulo para obtener suero"
    ],
    "c": 2,
    "e": "¡Correcto! Sirve para separar el suero y hacer pruebas de química sanguínea.",
    "curioso": "Dentro del tubo hay partículas de sílice que aceleran la anticoagulación en menos de 30 minutos."
  },
  {
    "cat": "Protección",
    "p": "¿En qué se diferencian los guantes de nitrilo de los de látex?",
    "o": [
      "Son iguales; solo cambia el nombre",
      "Resisten más y sirven si hay alergia al látex",
      "Son de tela gruesa y reutilizables"
    ],
    "c": 1,
    "e": "¡Correcto! El nitrilo no tiene látex, resiste mejor químicos y pinchazos.",
    "curioso": "El nitrilo es un caucho sintético que ofrece tres veces más resistencia a pinchazos que el látex."
  },
  {
    "cat": "Cirugía",
    "p": "¿Qué sonda usas si el paciente no puede orinar por sí mismo?",
    "o": [
      "Sonda Foley de dos vías",
      "Jeringa de 3 ml con aguja fina",
      "Cubrezapatos desechable"
    ],
    "c": 0,
    "e": "¡Correcto! La Foley drena la vejiga y el balón evita que se salga.",
    "curioso": "Se llama Foley en honor a Frederic Foley, el cirujano que la inventó en 1929."
  },
  {
    "cat": "Cirugía",
    "p": "¿Qué es una sonda nasogástrica para adulto?",
    "o": [
      "Sonda para drenar orina",
      "Tubo para ayudar a respirar",
      "Sonda de la nariz al estómago"
    ],
    "c": 2,
    "e": "¡Correcto! Lleva alimento o medicina al estómago si no puede tragar.",
    "curioso": "El material es de PVC grado médico diseñado para ser suave y no lastimar la nariz del paciente al pasar."
  },
  {
    "cat": "Inyectables",
    "p": "¿La jeringa de 1 ml con aguja 30×½ sirve para músculo grande?",
    "o": [
      "No: es fina y corta, uso superficial",
      "Sí: es la más grande del stock",
      "Sí: sirve para cualquier inyección"
    ],
    "c": 0,
    "e": "¡Correcto! Es tipo insulina; no alcanza bien un músculo profundo.",
    "curioso": "El calibre 30 es tan fino que a veces el paciente casi ni siente el pinchazo."
  },
  {
    "cat": "Laboratorio",
    "p": "¿Para qué son las puntas de pipeta amarillas?",
    "o": [
      "Decorar el área de trabajo",
      "Limpiar lentes del microscopio",
      "Medir líquidos sin contaminar la pipeta"
    ],
    "c": 2,
    "e": "¡Correcto! Se colocan en la pipeta y se desechan por cada muestra.",
    "curioso": "El color amarillo estandariza que son para volúmenes pequeños, usualmente de 1 a 200 microlitros."
  },
  {
    "cat": "Laboratorio",
    "p": "¿Qué es un tubo Eppendorf de 1.5 ml?",
    "o": [
      "Tubo largo para extraer sangre",
      "Tubito pequeño con tapa a presión",
      "Frasco de un litro para orina"
    ],
    "c": 1,
    "e": "¡Correcto! Guarda cantidades muy pequeñas de líquido en laboratorio.",
    "curioso": "¡El nombre viene de la empresa Eppendorf, pero ahora todo mundo les dice así a cualquier tubito similar!"
  },
  {
    "cat": "Cirugía",
    "p": "¿Qué es una tijera Iris?",
    "o": [
      "Tijera fina de precisión clínica",
      "Tijera grande para cortar vendas",
      "Herramienta para tuberías"
    ],
    "c": 0,
    "e": "¡Correcto! Es pequeña y precisa; se usa en curaciones y cirugía menor.",
  ...
  },
  {
    ...
    "o": [
      "Aparato para tomar la presión",
      "Manguera que lleva el suero a la vena",
      "Jeringa grande de 60 ml"
    ],
    "c": 1,
    "e": "¡Correcto! Conecta la bolsa de suero con el catéter del paciente.",
    "curioso": "Incluyen una cámara de goteo donde puedes conocer cuántas gotas por minuto están entrando al paciente."
  },
  {
    "cat": "Laboratorio",
    "p": "¿Para qué se usan portaobjetos y cubreobjetos juntos?",
    "o": [
      "El porta lleva la muestra y el cubre la protege",
      "Porque tienen el mismo tamaño exacto",
      "Solo para vender dos productos juntos"
    ],
    "c": 0,
    "e": "¡Correcto! Así se observa la muestra al microscopio sin ensuciar el lente.",
    "curioso": "El cubreobjetos es extremadamente delgado (aprox. 0.17 mm) para no distorsionar la imagen del microscopio."
  },
  {
    "cat": "Desechos",
    "p": "¿Dónde se desechan las agujas usadas?",
    "o": [
      "Bolsa de basura negra común",
      "Frasco de vidrio reutilizable",
      "Recipiente rígido de punzocortantes"
    ],
    "c": 2,
    "e": "¡Correcto! El recipiente rígido evita pinchazos al personal.",
    "curioso": "Se llaman 'guardianes' o 'biotrasher' y son obligatorios para prevenir accidentes laborales con fluidos infecciosos."
  },
  {
    "cat": "Diagnóstico",
    "p": "¿Con qué mides temperatura sin tocar a la persona?",
    "o": [
      "Termómetro de mercurio de vidrio",
      "Termómetro infrarrojo digital",
      "Estetoscopio de doble campana"
    ],
    "c": 1,
    "e": "¡Correcto! El infrarrojo mide a distancia y es más rápido.",
  ...
  },
  {
    ...
    "o": [
      "Es un algodón acolchado que va debajo del yeso para proteger la piel",
      "Es una venda elástica que aprieta mucho",
      "Es una venda para heridas con sangre"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "para limpieza general de superficies",
      "para control de temperatura ambiental",
      "Para conocer el flujo de líquidos en una vena"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Una cinta adhesiva de tela muy resistente",
      "Un tipo de papel de regalo cuando el caso es",
      "Es una venda elástica fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es un gel para curar heridas",
      "Es para lubricar la piel y que el ultrasonido",
      "Es para que los guantes no se peguen fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Un aparato para ver el interior del cuerpo",
      "Una lámpara para ver gargantas cuando el caso es",
      "Un equipo para escuchar los sonidos del corazón y pulmones"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "La bata estéril quirúrgica empaquetada",
      "La bata no estéril de examen cuando el caso es",
      "Un cubrezapatos grande fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Cinta de testigo",
      "Pulseras de identificación madre y niño/a",
      "Curitas de colores"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Calibres pequeños como 3 y 4",
      "Sondas Foley de dos vías cuando el caso es",
      "Calibres estándar de 6.5, 7 y 7.5"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "El catéter No. 22 (Azul)",
      "El catéter No. 18 (Verde)",
      "Una aguja dental"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "El tubo rojo (con activador)",
      "El tubo gris",
      "El tubo celeste (con citrato de sodio)"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Recipientes de 30ml",
      "Recipientes de 60ml y 120ml grado médico",
      "Tubos Eppendorf"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que el plástico resiste altas temperaturas sin",
      "Que no contiene restos bacterianos que puedan",
      "Que el empaque es transparente para ver el instrumental"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Cinta de testigo (o cinta indicadora)",
      "Rollo de papel Kraft solo cuando el caso es",
      "Guantes de examen"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "c": 1,
    "e": "¡Correcto! El tubo Penrose es un drenaje capilar de látex muy blando que se deja colocado en la herida para que los líquidos salgan por gravedad.",
  ...
  },
  {
    ...
    "o": [
      "El equipo de venoclisis normal (Normogotero)",
      "El equipo Microgotero",
      "Una sonda de aspiración fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para tapar los tubos de ensayo vacíos",
      "Para sellar un catéter intravenoso",
      "Para limpiar los microscopios"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "La bolsa de orina para pierna con tiras de sujeción",
      "La bolsa de orina para cama (estándar)",
      "Un recipiente de heces de 30ml fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      ...
      "Un espéculo vaginal descartable",
      "Una pinza Iris"
    ],
    "c": 1,
    "e": "¡Correcto! El espéculo vaginal de plástico transparente permite una visión perfecta y, al ser desechable, le garantiza a la paciente higiene total y cero riesgo de contaminación cruzada.",
  ...
  },
  {
    ...
    "o": [
      "Los estériles vienen sellados individualmente",
      "Solo cambia el color de la madera cuando el caso es",
      "Los estériles son de plástico y los no"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "La mascarilla normal de tres pliegues",
      "Un gorro de cirujano cuando el caso es",
      "La mascarilla con visor o pantalla protectora"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Un termohigrómetro",
      "Un tubo endotraqueal cuando el caso es",
      "Un termómetro digital flexible o infrarrojo"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "La jeringa de 1ml con aguja fina 30x1/2",
      "La jeringa de 10ml con aguja verde No. 18",
      "Una jeringa de 60ml"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Verificar que el empaque esté sellado de fábrica",
      "Lavarlo con agua común antes de usar",
      "Usarlo varias veces en distintos pacientes"
    ],
    "c": 0,
    "e": "¡Correcto! Las hojas de bisturí son estrictamente de un solo uso y vienen estériles. Cualquier daño en su empaque individual significa que debe descartarse de inmediato.",
  ...
  },
  {
    ...
    "o": [
      "Sirve para apretar un esguince con fuerza",
      "Es para poner debajo del yeso cuando el caso es",
      "Sirve para sostener apósitos o gasas sobre"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Una regla para medir las jeringas",
      "Un indicador químico impreso (testigo) que",
      "El nombre de los cirujanos de la región"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Tubos de centrífuga cónicos graduados",
      "Sello de heparina",
      "Bajalenguas de madera fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para mezclar reactivos de laboratorio",
      "Para entablillar dedos rotos únicamente",
      "Para deprimir la lengua del niño y tener"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "El de enfermera (estilo hongo) es más amplio",
      "Solo cambia el precio cuando el caso es",
      "Uno es de tela de algodón gruesa y el otro es"
    ],
    "c": 0,
    "e": "¡Correcto! El gorro de enfermera o cofia redonda está diseñado para cubrir cabelleras voluminosas por completo, mientras que el de cirujano cubre la cabeza de forma más ajustada con cintas de amarre.",
  ...
  },
  {
    ...
    "o": [
      ...
      "Bolsas de papel para esterilizar"
    ],
    "c": 1,
    "e": "¡Correcto! Los zapatones o cubrecalzados evitan que la suciedad de la calle o de los pasillos comunes entre a las zonas de máxima pureza del hospital.",
  ...
  },
  {
    ...
    "o": [
      "Un frasco de 120ml",
      "Un tubo de centrífuga cónico",
      "Un recipiente de heces de 30ml"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "La bolsa de orina para cama",
      "La bolsa de orina para pierna",
      "Un recipiente de 60ml fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! La bolsa de cama tiene gran capacidad (2000ml) y cuenta con un gancho resistente para mantenerse vertical al lado del colchón sin riesgo de caídas.",
  ...
  },
  {
    ...
    "o": [
      "El normogotero pasa gotas grandes (ideal para adultos) y el microgotero pasa gotitas",
      "El microgotero se usa solo para pasar sangre y el normogotero para agua pura",
      "El normogotero funciona con baterías y el microgotero funciona por pura gravedad"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Se miden en miligramos (mg) de azúcar por cada",
      "Se miden en Unidades Internacionales (UI) y jamás",
      "Se miden en centímetros cúbicos estándar"
    ],
    "c": 1,
    "e": "¡Correcto! esa es! La insulina es un medicamento delicadísimo. Si un paciente se inyecta 1 ml de insulina pensando que es una dosis normal, podría caer en coma. Por eso estas jeringas vienen marcadas directamente en Unidades (ej. 10, 20, 100 UI).",
  ...
  },
  {
    ...
    "o": [
      "Porque el agua de chorro duerme los nervios y quita el dolor de golpe",
      "Porque contiene antibióticos fuertes que matan",
      "Porque tiene la misma concentración de sal"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Permite regular con total precisión el porcentaje exacto de oxígeno (FiO2) que recibe",
      "Viene con un motor integrado que calienta el aire para que no le dé tos al paciente",
      "Está hecha de un material transparente que"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Funciona como un pegamento temporal",
      "Elimina el aire entre el equipo y la piel",
      "Trae un anestésico suave para que el paciente"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "El rollo de papel Kraft grande",
      "Las bolsas para esterilizar autoadhesivas",
      "Un recipiente de heces fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Esfigmomanómetro aneroide manual",
      "Oxímetro de pulso",
  ...
  },
  {
    ...
    "o": [
      "En bolsas de bolitas de algodón",
      "En presentación de Libra de Algodón",
      "Venda de guata"
    ],
    "c": 1,
    "e": "¡Correcto! La libra de algodón es el formato industrial y clínico por excelencia. Permite a las enfermeras cortar los pedazos del tamaño exacto que necesiten.",
  ...
  },
  {
    ...
    "o": [
      "La Bolsa de Bolitas de Algodón",
      "La Libra de Algodón en rollo",
      "Cinta de testigo"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "La mascarilla normal de tres pliegues",
      "La mascarilla con visor integrado",
      "Gorro de cirujano"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Guante quirúrgico estéril talla 6",
      "Guante de examen talla L cuando el caso es",
      "Guante quirúrgico estéril talla 8"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      ...
      "Guante de examen talla XS fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "c": 1,
    "e": "¡Correcto! Las tallas 7 y 7.5 son el corazón del inventario de guantes quirúrgicos, ya que cubren a la gran mayoría del personal de salud adulto.",
  ...
  },
  {
    ...
    "o": [
      ...
      "Venda de gasa",
      "Guantes de examen tallas S, M, L"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Puntas de pipeta (amarillas/azules)",
      "Tubos Eppendorf de 1.5ml cuando el caso es",
      "Portaobjetos de vidrio fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      ...
      "Frascos de orina de 60ml cuando el caso es",
      "Tubos microcentrífuga tipo Eppendorf de 1.5ml"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Otro portaobjetos grueso",
      "El cubreobjetos de vidrio",
      "Un sello de heparina"
    ],
    "c": 1,
    "e": "¡Correcto! El cubreobjetos aplana la gota de la muestra para que quede uniforme y evita que los líquidos entren en contacto directo con el lente del microscopio.",
  ...
  },
  {
    ...
    "o": [
      "Un equipo de venoclisis (Normogotero)",
      "Un microgotero",
      "Una llave de tres vías fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Venda de guata",
      "Venda elástica tradicional",
      "Venda de gasa ligera"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "c": 2,
    "e": "¡Correcto! El oxímetro de pulso mide la saturación de oxígeno emitiendo una luz que cruza la uña del paciente. Lo normal es que marque entre 95% y 100%.",
  ...
  },
  {
    ...
    "o": [
      "El tubo morado con EDTA",
      "El tubo celeste",
      "El tubo amarillo con gel"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "c": 0,
    "e": "¡Correcto! La cinta de testigo es el adhesivo oficial de los departamentos de esterilización. Soporta la humedad y el calor extremo sin despegarse de los envoltorios.",
  ...
  },
  {
    ...
    "c": 2,
    "e": "¡Correcto! Los bajalenguas son tiras de madera pulida y plana. Permiten empujar la lengua hacia abajo para evaluar si las amígdalas están inflamadas o tienen infección.",
  ...
  },
  {
    ...
    "o": [
      "Gorro de cirujano con tiras",
      "Gorro de enfermera (o cofia redonda",
      "Zapatones"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      ...
      "Recipiente de orina de 60ml cuando el caso es",
      "Tubos microcentrífuga tipo Eppendorf de 1.5ml"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Rollo de papel Kraft grado médico",
      "Bolsas de esterilización autoadhesivas",
      "Cinta de Castilla"
    ],
    "c": 0,
    "e": "¡Correcto! El rollo de papel Kraft médico permite cortar los tramos del tamaño exacto de nuestros apósitos o sábanas para meterlos a esterilizar en lotes grandes.",
  ...
  },
  {
    ...
    "o": [
      "Porque los de plástico se lavan con cloro común",
      "Porque son desechables, eliminan el costo de esterilización y dan total seguridad a la paciente",
      "Porque son más grandes fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      ...
      "Portaobjetos",
      "Hisopos estériles o no estériles"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Mascarillas con visor integrado",
      "Mascarillas normales de tres pliegues",
      "Zapatones"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "c": 1,
    "e": "¡Correcto! La talla XS es ideal para manos pequeñas. Queda ceñida y evita que se formen pliegues sueltos que estorben al manipular jeringas o pinzas.",
  ...
  },
  {
    ...
    "o": [
      "Termohigrómetro de bodega",
      "Termómetro digital flexible o infrarrojo",
      "Esfigmomanómetro manual fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Jeringa de 1ml con aguja fina 30x1/2",
      "Jeringa de 5ml aguja No. 21 cuando el caso es",
      "Jeringa de 20ml"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Tienen una base cilíndrica lisa de plástico",
      "Son iguales a las agujas de las jeringas comunes",
      "Tienen una rosca interna especial de plástico"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "c": 0,
    "e": "¡Correcto! La venda de gasa común es perfecta para curaciones ligeras. Mantiene el apósito en su sitio, permite el paso de aire y no ejerce presión dolorosa en la herida.",
  ...
  },
  {
    ...
    "o": [
      "Iniciar maniobras de RCP (reanimación) y pedir",
      "Llenar la ficha de ingreso administrativo",
      "Llevar al paciente a tomarse una radiografía"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es más rápido y solo usa agua tibia",
      "Se hace con jabón antiséptico",
      "Se realiza usando guantes de examen puestos"
    ],
    "c": 1,
    "e": "¡Correcto! El lavado quirúrgico es sumamente estricto para eliminar la mayor cantidad de bacterias de la piel. Además, los brazos deben mantenerse siempre hacia arriba para no contaminarse.",
  ...
  },
  {
    ...
    "o": [
      "Estatura, peso, color de ojos y reflejos",
      "Presión arterial, frecuencia cardíaca,",
      "Nivel de azúcar, tipo de sangre, peso y fuerza"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para que el cirujano descanse 5 minutos",
      "Para verificar en voz alta el nombre del paciente, el procedimiento exacto y el sitio quirúrgico correcto, evitando errores",
      "Para esperar a que los sueros se terminen"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "A que el paciente recibió una mala noticia y está asustado",
      "A que la presión arterial cayó tanto que el oxígeno",
      "A que el paciente tiene un ataque de nervios"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para calcular cuánta anestesia le van a poner",
      "Para saber si la sangre del paciente cierra",
      "Para ver si el paciente tiene anemia"
    ],
    "c": 1,
    "e": "¡Correcto! Si los tiempos están prolongados, significa que la sangre tarda mucho en formar coágulos. Operar así es peligrosísimo porque el paciente podría desangrarse.",
  ...
  },
  {
    ...
    "o": [
      "Que la herida se está infectando y tiene pus",
      "Que está sanando bien, formando tejido nuevo,",
      "Que la piel se está secando y descamando"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "El respirador N95 (o equivalente de alta",
      "La mascarilla con visor de plástico fina",
      "Un gorro de cirujano cerrado fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "El nivel de dolor del paciente del 1 al 10",
      "El nivel de conciencia y respuesta",
  ...
  },
  {
    ...
    "o": [
      "Escribir el reporte en la computadora",
      "Conocer la técnica quirúrgica a fondo para anticiparse y pasarle los bisturís, pinzas y suturas exactas al cirujano",
      "Ir a traer los sueros a la bodega general"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para ver cuánto material van a cobrar en la factura final",
      "Para asegurarse de que no se haya quedado",
      "Para guardarlas y usarlas en otro turno"
    ],
    "c": 1,
    "e": "¡Correcto! Olvidar una gasa o una aguja dentro de un paciente es una complicación grave que causa infecciones severas. Nadie cierra la herida hasta que el conteo da exacto.",
  ...
  },
  {
    ...
    "o": [
      "Que el suero tiene la misma concentración de sal y agua que",
      "Que el suero tiene muchísima más azúcar que la sangre",
      "Que es agua pura destilada sin ningún mineral"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      ...
      "La vacuna de la Influenza fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "En extraer muestras de sangre y ponerlas en frascos",
      "En contar cuántos glóbulos rojos tiene el paciente",
      "En medir el nivel de grasa en las arterias"
    ],
    "c": 0,
    "e": "¡Correcto! El hemocultivo busca 'cazar' a la bacteria causante de la fiebre. Es vital para cambiar los antibióticos generales por uno específico que mate directamente al microbio.",
  ...
  },
  {
    ...
    "o": [
      "Que los medicamentos de la anestesia no hagan efecto",
      "Que el paciente vomite estando dormido y los fluidos del estómago viajen a los pulmones causando asfixia o neumonía grave",
      "Que el paciente tenga mucha hambre durante la operación"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Cobrar la consulta antes de que el paciente vea",
      "Clasificar a los pacientes por colores según",
      "Asignar las camas libres por orden de llegada"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Porque ahí la piel es menos gruesa y duele menos",
      "Para evitar pinchar por accidente el Nervio",
      "Porque es la zona que más rápido absorbe los sueros"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "A que la herida se dejó abierta",
      "A que los bordes limpios de la piel se",
      "A que la herida se infectó y requirió antibióticos"
    ],
    "c": 1,
    "e": "¡Correcto! La primera intención ocurre cuando el corte es limpio (como el de un bisturí) y el doctor junta los bordes con hilo de sutura, permitiendo que sane rápido y deje poca cicatriz.",
  ...
  },
  {
    ...
    "o": [
      "Tubo rojo con activador de coágulo",
      "Tubo amarillo con gel separador",
      "Tubo morado con EDTA (hematología)"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Quemaduras por fricción clínica",
      "Úlceras por presión (o escaras)",
      "Micosis intrahospitalarias"
    ],
    "c": 1,
    "e": "¡Correcto! El peso del cuerpo aplasta los vasos sanguíneos contra el colchón, dejando a la piel sin sangre ni oxígeno hasta que el tejido muere y se abre una úlcera.",
  ...
  },
  {
    ...
    "o": [
      "A un silbido agudo continuo provocado por el aire",
      "A un burbujeo de agua líquida dentro del pecho",
      "Al roce de dos papeles secos fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es la encargada de operar junto al cirujano principal",
      "Está fuera del área estéril, asiste al equipo",
      "Controla únicamente las máquinas de anestesia"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Directamente adentro de una vena grande",
      "En el tejido graso que se encuentra justo",
      "En el fondo del músculo esquelético"
    ],
    "c": 1,
    "e": "¡Correcto! La vía subcutánea deposita el fármaco en la grasita. Como ahí hay menos flujo de sangre que en el músculo, el medicamento se absorbe de forma lenta y continua.",
  ...
  },
  {
    ...
    "o": [
      "Porque los hilos con números acompañados de ceros (como",
      "Porque el hilo 2-0 es de plástico transparente",
      "Porque los hilos finos se absorben solos en la piel"
    ],
    "c": 0,
    "e": "¡Correcto! En las suturas, cuantos más ceros tenga el número, más delgada es la hebra. Un hilo 6-0 es casi tan fino como un cabello humano, ideal para la estética de la cara.",
  ...
  },
  {
    ...
    "o": [
      "Isocoria pupilar clínica",
      "Anisocoria",
      "Miosis bilateral profunda"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      ...
      "Un monitor de signos vitales portátil"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Adrenalina (Epinefrina) inyectada de inmediato",
      "Un jarabe para la tos común cuando el caso es",
      "Una dosis alta de suero glucosado fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para que el paciente no se mire la herida y se asuste",
      "Para aislar la herida mientras la capa",
      "Para mantener la piel completamente húmeda con agua"
    ],
    "c": 1,
    "e": "¡Correcto! En las primeras horas la piel aún no ha soldado. Dejarla tapada con un apósito estéril evita que los microbios del aire o las sábanas infecten el corte fresco.",
  ...
  },
  {
    ...
    "o": [
      "Se extrae de una arteria profunda (como la de la muñeca), la sangre es roja brillante y mide directamente el oxígeno y el pH del cuerpo",
      "Se toma pinchando un dedo con una lanceta pequeña",
      "Se extrae de las venas del pie usando tubos"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Porque la máquina se arruina con el humo del ambiente",
      "Porque el monóxido de carbono se pega a la hemoglobina y el sensor del oxímetro lo confunde con oxígeno real",
      "Porque el humo calienta los dedos del paciente"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Inyecta el medicamento directamente en el catéter de la vena en un periodo corto de 1 a 5",
      "Diluye el medicamento en una bolsa grande de un litro de suero para pasar en todo el día",
      "Aplica el medicamento directo en el músculo del brazo"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Una gastritis severa crónica",
      "Una Apendicitis Aguda",
      "Cálculos en la vesícula biliar"
    ],
    "c": 1,
    "e": "¡Correcto! El punto de McBurney está ubicado en el cuadrante inferior derecho del abdomen, justo sobre el apéndice. Si el paciente salta de dolor al presionar y soltar ahí, es señal casi segura de apendicitis.",
  ...
  },
  {
    ...
    "o": [
      "Para que el líquido se seque más rápido con el aire",
      "Para arrastrar las bacterias lejos de la zona",
      "Por pura estética del campo quirúrgico"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Una venda elástica en la cabeza",
      "Un collarín cervical rígido",
      "Una sonda de alimentación ajustable"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      ...
      "La salud y capacidad de filtración de los Riñones",
      "El estado del hígado fuera de esta"
    ],
    "c": 1,
    "e": "¡Correcto! La creatinina es un desecho del cuerpo que los riñones sanos filtran y botan por la orina. Si los riñones están fallando, la creatinina se acumula y sube en la sangre.",
  ...
  },
  {
    ...
    "o": [
      "De 2 a 3 días como máximo",
      "De 7 a 14 días, dependiendo de la tensión",
      "Un mes entero de reposo fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Catéter 24G (Color Amarillo)",
      "Catéter 22G (Color Azul) cuando el caso es",
      "Catéter 14G o 16G (Color Naranja o Gris)"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Sutura de Seda Negra (No absorbible)",
      "Sutura de Ácido Poliglicólico o Poliglactina",
      "Hilo de Nylon Monofilamento (No absorbible)"
    ],
    "c": 1,
    "e": "¡Correcto! Las suturas absorbibles sintéticas se degradan por hidrólisis (el agua del cuerpo las deshace). Son las reinas para coser tejidos internos como el útero o los músculos abdominales.",
  ...
  },
  {
    ...
    "o": [
      "Que la aguja se introduce a presión y se puede",
      "Que tiene una rosca de seguridad donde la aguja se",
      "Que la jeringa viene fabricada de vidrio templado"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que vienen empacados en pares individuales",
      "Que son de un material plástico transparente",
      "Que se pueden lavar con cloro y volver a usar"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Hacer que el tubo flote dentro del cuerpo",
      "Sellar la tráquea para que el aire de la máquina no se",
      "Servir de filtro para las bacterias del ambiente"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para alimentación directa hacia el estómago a",
      "Para introducir oxígeno a alta presión por la boca",
      "Para el drenaje continuo de orina desde la vejiga,"
    ],
    "c": 2,
    "e": "¡Correcto! La sonda Foley va directo a la uretra hasta llegar a la vejiga. Tiene dos vías: una para que salga la orina hacia la bolsa recolectora y otra para inflar el balón de retención con agua estéril para que no se salga.",
  ...
  },
  {
    ...
    "o": [
      "Solución Salina Normal al 0.9% (o Cloruro de Sodio al 0.9%)",
      "Agua destilada pura en bolsa cuando el caso es",
      "Solución de Glucosa al 50% fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Mide la presión en milímetros de mercurio (mmHg)",
      "Mide el flujo de oxígeno entregado al paciente en Litros por Minuto (LPM)",
      "Mide la temperatura del gas en grados centígrados"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que brilla en la oscuridad si se apagan las luces",
      "Que contiene un hilo especial que se ve",
      "Que absorbe el doble de líquido que una gasa común"
    ],
    "c": 1,
    "e": "¡Correcto! Ese hilo que traen es radiopaco. Si al terminar una cirugía el conteo de gasas no cuadra, le toman una placa de Rayos X al paciente en la mesa y la gasa perdida va a brillar en la imagen.",
  ...
  },
  {
    ...
    "o": [
      "Porque la clorhexidina tiene un efecto",
      "Porque la clorhexidina es de color rojo brillante",
      "Porque es mucho más barata y se hace con agua común"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Se instala en las venas pequeñas de la mano",
      "Se introduce en una vena grande del cuello",
      "Es una sonda que va directo al riñón"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para enfriar la piel del paciente y que no sude",
      "Es un puente para que la electricidad del corazón",
      "Para pegar el parche con fuerza y que no se"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "En órganos blandos como el intestino para pasar",
      "En la piel externa porque es redonda y no deja",
      "En tejidos duros como los tendones o huesos"
    ],
    "c": 0,
    "e": "¡Correcto! La aguja cilíndrica es como un cono liso: hace el agujero empujando las fibras hacia los lados sin cortar. Si usaras una aguja con filo en un intestino, lo rajarías de lado a lado al jalar el hilo.",
  ...
  },
  {
    ...
    "o": [
      "Un sistema de hilos cruzados",
      "Tres capas de plástico que bloquean fluidos y bacterias pero dejan pasar el aire",
      "Una tela especial con seda orgánica que no"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Conectar dos sueros diferentes al mismo",
      "Servir de tapón mecánico para que la sangre no",
      "Regular la presión del oxígeno en las mascarillas de la emergencia"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Conectar ahí una jeringa con agua para limpiar",
      "Dejarlo libre para que el aire de la sala",
      "Taparlo con el dedo solo al salir para activar la succión de forma segura"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Para que el médico pueda ver el nivel del líquido en la oscuridad",
      "Porque la goma negra reacciona cambiando de color si el medicamento está vencido",
      "Para asegurar un sello hermético que evite"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Porque las fibras sueltas se pegan a la costra y al cambiarlas arrancan el tejido nuevo",
      "Porque el algodón absorbe los medicamentos y les quita el efecto por completo",
      "Porque el hilo de algodón tradicional altera el pH de la piel y causa ardor químico"
    ],
    "c": 0,
    "e": "¡Correcto! La gasa de algodón común es buenísima para secar sangre, pero si la dejas sobre tejido vivo, los hilos se amarran a la carne nueva. Al quitarla al día siguiente, te traes la piel nueva y hacés sangrar al paciente otra vez.",
  ...
  },
  {
    ...
    "o": [
      "El grosor de la aguja (calibre)",
      "El tipo de medicamento que se puede pasar",
      "La marca del fabricante para evitar que se"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que las cintas tienen analgésico que se absorbe",
      "Que distribuyen la tensión de forma pareja",
      "Que se caen solas en menos de 24 horas"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Sirve de ventana para monitorear si la bolsa ya",
      "Es un filtro de carbón activado que deja",
      "Es un sensor térmico que avisa si el contenido"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Tiene un químico que le saca brillo espejo al acero inoxidable",
      "Contiene enzimas que devoran y deshacen los restos de sangre y tejido humano",
      "Es un desinfectante ultra fuerte que mata el 100% de los virus en frío"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "La manguera se revienta por la presión del tanque",
      "No oxigena más y solo le reseca y lastima la nariz al paciente",
      "El oxígeno se empieza a salir por los lados y se desperdicia"
    ],
    "c": 1,
    "e": "¡Correcto! Las bigoteras son para flujos bajos. Si el paciente necesita más de 5 o 6 litros, ponerle más presión con la bigotera es como meterle un compresor de aire en la nariz: le va a doler y sangrar. Para flujos altos se usa mascarilla.",
  ...
  },
  {
    ...
    "o": [
      "Que la orina vieja de la bolsa regrese a la vejiga del paciente y le cause una infección",
      "Que el olor de la orina se salga de la bolsa y apeste la habitación",
      "Que la bolsa se rompa si se llena a su máxima capacidad"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Usa un resorte interno que empuja los líquidos",
      "La sangre y el suero resbalan por fuera del látex",
      "Absorbe los líquidos como si fuera una esponja"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Todo lo que esté contaminado con fluidos",
      "Los cartones de las medicinas, botellas",
      "Los restos de comida de los pacientes y las envolturas de los insumos"
    ],
    "c": 0,
    "e": "¡Correcto! La bolsa roja significa 'Peligro Biológico'. Todo lo que toque sangre, fluidos o tejidos va ahí porque requiere un camión especial que lo lleva a incineradores industriales. Si tiras basura común ahí, metes al hospital en un gran problema.",
  ...
  },
  {
    ...
    "o": [
      "Llegar al estómago para vaciar los ácidos y evitar que vomite",
      "Entrar a la vejiga por la uretra para medir",
      "Meterse en la tráquea para asegurar que los pulmones reciban aire limpio"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Se mete dentro del pañal suelta",
      "Se pega directo a la piel alrededor de sus",
      "Se conecta a una micro-sonda que entra a la vejiga del bebé"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "El número 14G (Color Naranja)",
      "El número 18G (Color Verde)",
      "El número 24G (Color Amarillo)"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Permite que la aguja se deslice más rápido para vacunar en masa",
      "Evita que la aguja salga disparada por la presión de líquidos espesos",
      "Hace que el plástico de la jeringa aguante más"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Un hilo detectable en Rayos X para encontrar",
      "Una fibra ultra absorbente que dobla la capacidad de retención de sangre de la gasa",
      "Un componente químico que hace que la gasa"
    ],
    "c": 0,
    "e": "¡Correcto! En el corre-corre de una cirugía de abdomen se usan docenas de gasas. Si al contar el equipo antes de cerrar los números no cuadran, le toman una radiografía rápida al paciente en la camilla y ese hilo negro brillará en la placa si la gasa se quedó adentro.",
  ...
  },
  {
    ...
    "o": [
      "Porque el primer chorro sale con mucha fuerza y puede romper el frasco de plástico",
      "Para que el primer chorro limpie las bacterias de la piel y el frasco lleve solo la orina pura",
      "Porque la primera orina viene muy concentrada y altera los reactivos químicos"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Porque es liso, plástico y no se enreda ni se",
      "Porque se deshace solo con el sudor de la cabeza en un par de semanas",
      "Porque es el único hilo orgánico que ayuda a"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Hipertermia maligna crítica",
      "Hipotermia clínica moderada",
      "Fiebre (o Pirexia)"
    ],
    "c": 2,
  ...
  },
  {
    ...
    "o": [
      "Muestra el promedio real del azúcar del paciente durante los últimos 3 meses",
      "Mide los miligramos de azúcar exactos que el paciente tiene en ese preciso segundo",
      "Indica la cantidad de glóbulos blancos que"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Se inyecta puro en la vena en dos segundos",
      "Se diluye en una bolsa pequeña de suero",
      "Se mezcla con una crema para aplicarlo directo"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Midriasis pupilar severa",
      "Miosis profunda",
      "Anisocoria neurológica"
    ],
    "c": 1,
    "e": "¡Correcto! La miosis es la contracción extrema de la pupila. Es el chivato inmediato que ven los médicos en los ojos de pacientes que ingresan por sobredosis de narcóticos, opioides o intoxicaciones por químicos pesados.",
  ...
  },
  {
    ...
    "o": [
      "El tubo morado con EDTA",
      "El tubo celeste con citrato",
      "El tubo gris de glucosa"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "c": 1,
    "e": "¡Correcto! La dehiscencia ocurre cuando los hilos de sutura se rompen o desgarran la piel antes de que esta haya soldado por completo. Requiere una revisión médica inmediata.",
  ...
  },
  {
    ...
    "o": [
      "El reflejo corneal del ojo",
      "El reflejo nauseoso (o faríngeo)",
      "La fuerza de masticación de la mandíbula"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Anotar la hora exacta de colocación en la frente del paciente o en la banda del torniquete y nunca quitarlo a ciegas fuera del hospital",
      "Aflojarlo cada 5 minutos para que la herida respire",
      "Cubrirlo con vendas calientes de guata"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Mantener el hueso caliente por las noches",
      "Funcionar como un colchón protector de algodón",
      "Evitar que la sangre pase por la pierna"
    ],
    "c": 1,
    "e": "¡Correcto! La venda de guata es una armadura de algodón suave. Protege tobillos, codos o rodillas de la fricción y presión del material exterior duro.",
  ...
  },
  {
    ...
    "o": [
      "Exactamente dos horas después de que el paciente",
      "En ayunas completo a las 5 de la mañana",
      "Justo en medio de una crisis de fiebre alta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para dormir los nervios del dolor del brazo",
      "Para frenar el retorno de la sangre por las venas,",
      "Para desinfectar la piel por presión"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Los movimientos de los intestinos de la madre",
      "Los latidos del corazón del bebé dentro del vientre, que son rápidos como el galope de un caballo",
      "El flujo de aire en los pulmones de la madre"
    ],
    "c": 1,
    "e": "¡Correcto! El Doppler fetal amplifica las ondas de sonido del corazón del feto. El ritmo normal de un bebé es altísimo, entre 120 y 160 latidos por minuto.",
  ...
  },
  {
    ...
    "o": [
      "Que contiene una mezcla balanceada de electrolitos",
      "Que tiene sabor dulce y colorante clínico",
      "Que espesa los líquidos del estómago de inmediato"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Mantener la cabeza caliente bajo el aire",
      "Cubrir por completo el cabello y las orejas",
      "Identificar quién es el jefe del turno por el color del gorro"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Viene graduada en 'Unidades' (U-100) en lugar",
      "Es una jeringa gigante de 50ml para lavado",
      "Viene con una aguja gruesa de color verde"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para adultos con venas muy gruesas en emergencias",
      "Para bebés, pacientes pediátricos o ancianos",
      "Para conectar mangueras de alimentación pesadas"
    ],
    "c": 1,
    "e": "¡Correcto! El No. 24 es el catéter más pequeño y delgado del catálogo hospitalario. Su color amarillo avisa de inmediato que es para uso neonatal o pediátrico.",
  ...
  },
  {
    ...
    "o": [
      "Es una sutura no reabsorbible de origen",
      "Se disuelve sola en la piel en 3 días",
      "Es un hilo elástico invisible fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es una sonda rígida de metal pesado",
      "Es una manguera simple y recta sin balón de fijación",
      "Tiene tres bolsas de agua colgando fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Contienen anticoagulante líquido para mantener",
      "No tienen anticoagulante (el rojo es seco y el amarillo trae gel separador) y sirven para obtener suero para pruebas químicas",
      "Tienen agua destilada para lavar la aguja"
    ],
    "c": 1,
    "e": "¡Correcto! Estos tubos buscan que la sangre se coagule a propósito. Al centrifugar el tubo, las células se van al fondo y arriba queda el suero limpio para medir glucosa, colesterol o triglicéridos.",
  ...
  },
  {
    ...
    "o": [
      "Que sus bordes están tejidos de fábrica",
      "Que son completamente impermeables al agua",
      "Que vienen impregnadas con yeso blanco"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Exactamente 10 gotas pesadas",
      "Exactamente 60 microgotas",
      "Mil gotas diminutas"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para medir la presión del brazo",
      "Para conectar varias líneas de suero o",
      "Para bloquear la entrada de aire al pulmón"
    ],
    "c": 1,
    "e": "¡Correcto! La llave de tres vías permite desviar el flujo. El enfermero puede pasar el suero principal y, al girar la perilla, inyectar una ampolleta por el otro puerto de forma limpia.",
  ...
  },
  {
    ...
    "o": [
      "Un termómetro digital para la frente",
      "Un aparato manual para medir la presión",
      "Una máquina para medir el azúcar"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para que la gasa no se pegue al tejido vivo",
      "para control de temperatura ambiental",
      "para archivo de documentos clínicos"
    ],
    "c": 0,
    "e": "¡Correcto! Una gasa seca sobre una quemadura se convierte en una pesadilla porque se suelda con el líquido de la herida. La vaselinada mantiene la zona húmeda y protegida.",
  ...
  },
  {
    ...
    "o": [
      "Para pasar gotas de ojos con calma",
      "Para pasar grandes volúmenes de sueros a",
      "Únicamente para pacientes recién nacidos"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que sea una sutura absorbible sintética que",
      "Que sea de metal para que nunca se deshaga",
      "Que sirva para pegar huesos rotos fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es una sonda larga que entra por la nariz",
      "Es un tubo para los oídos cuando el caso es",
      "Se coloca en la vejiga para sacar piedras"
    ],
    "c": 0,
    "e": "¡Correcto! La sonda Levin es una manguera flexible de plástico con marcas de distancia en centímetros. Permite vaciar los gases del estómago o pasar fórmulas nutritivas directo al paciente.",
  ...
  },
  {
    ...
    "o": [
      "Para cubrir quemaduras de tercer grado secas",
      "Para fijar y proteger los catéteres",
      "Para limpiar el instrumental médico"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Se debe calentar con una secadora de pelo",
      "Se sumerge por completo en agua unos segundos",
      "Se aplica seca y se estira con fuerza"
    ],
    "c": 1,
    "e": "¡Correcto! Al mojar la venda, el yeso se hidrata y empieza una reacción química que genera calor y solidifica el material en pocos minutos, creando el molde rígido.",
  ...
  },
  {
    ...
    "o": [
      "Contiene Citrato de Sodio y se usa",
      "Contiene gel de grasa para separar suero",
      "Trae alcohol puro para fijar células"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es una manta continua de algodón puro doblada",
      "Viene mezclado con plástico duro cuando el caso es",
      "Está empapado en alcohol de fábrica fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! El algodón plisado es el estándar para clínicas y botiquines. Permite al enfermero desenrollar la manta, cortar un trozo cuadrado para hacer tórulas o almohadillas y optimizar el producto.",
  ...
  },
  {
    ...
    "o": [
      "La presión arterial sistólica y la temperatura",
      "La saturación de oxígeno en la sangre (SpO2)",
      "El nivel de azúcar y el peso de la persona"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Para transfusiones masivas de sangre en accidentes graves",
      "Para venas delgadas de adultos, pacientes de la tercera edad o",
      "Para cirugías de corazón abierto únicamente"
    ],
    "c": 1,
    "e": "¡Correcto! El calibre 22 es un tamaño mediano tirando a delgado. Entra con facilidad en venas difíciles o colapsadas de pacientes deshidratados donde un catéter verde no pasaría jamás.",
  ...
  },
  {
    ...
    "o": [
      "Que el hilo está hecho de una sola hebra",
      "Que el hilo viene trenzado con muchas cuerdas",
      "Que se estira como un elástico de hule"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "para limpieza general de superficies",
      "Para que el enfermero tape el agujero",
      "para archivo de documentos clínicos"
    ],
    "c": 1,
    "e": "¡Correcto! Si la succión fuera continua desde que entra, la sonda se pegaría a las paredes de la boca o tráquea causando sangrados. Al tapar la válvula con el dedo, se controla el vacío de forma segura.",
  ...
  },
  {
    ...
    "o": [
      "Contiene EDTA (un potente anticoagulante) y se usa para hacer la Hematología Completa o conteo de células",
      "Trae azúcar pura concentrada para conservar la muestra",
      "Contiene gel de sílice para espesar la sangre"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que está hecha de algodón mezclado con hilos",
      "Que es de papel desechable cuando el caso es",
      "Que se pega sola sin ganchos fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! Las vendas elásticas estiran y aprietan de forma controlada. Son las reinas para tratar torceduras de tobillo, asegurar férulas de yeso o mejorar la circulación venosa.",
  ...
  },
  {
    ...
    "o": [
      "Es un equipo de suero que incluye un cilindro",
      "Es una jeringa gigante de metal cuando el caso es",
      "Un frasco de vidrio para muestras de tejido"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que su adhesivo de resina es sumamente fuerte",
      "Que se deshace con el agua en segundos",
      "Que es transparente y estéril fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! El esparadrapo de tela es el de batalla. Aguanta el sudor, el movimiento y la tensión mecánica pesada en hospitales y clínicas de campo.",
  ...
  },
  {
    ...
    "o": [
      "La campana pequeña sirve para escuchar ruidos",
      "Es solo un adorno estético del metal cuando el caso",
      "Para conectar mangueras de oxígeno adicionales"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Porque es el color favorito de las clínicas estéticas",
      "Porque es el tamaño intermedio perfecto: es",
      "Porque solo sirve para inyectar agua pura"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "De hilos de plástico reciclado pulido",
      "De colágeno puro obtenido de la capa",
      "De fibras de plantas medicinales trenzadas"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Se amarra al brazo con una venda elástica",
      "Se conecta directamente al extremo libre de la Sonda Foley",
      "Se coloca suelta debajo de las sábanas sin manguera"
    ],
    "c": 1,
    "e": "¡Correcto! La bolsa tiene un tubo largo de PVC que encaja a presión de forma estéril con la sonda Foley. La orina baja por gravedad y se almacena de forma limpia en la bolsa graduada.",
  ...
  },
  {
    ...
    "o": [
      "Una aguja larga para raquidea",
      "Una micro-hoja de metal con punta triangular",
      "Un tubo de vidrio para centrífuga fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Viene en capas ya cortadas en forma de bandas",
      "Es de plástico inflable con aire cuando el caso es",
      "No necesita agua para endurecerse fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! La férula solo cubre una mitad del miembro para inmovilizar sin apretar por completo. Es perfecta para emergencias donde el brazo está muy inflamado y un yeso cerrado cortaría la circulación.",
  ...
  },
  {
    ...
    "o": [
      "Es una aguja de metal fija unida a una manguera",
      "Un catéter que deja un tubo de plástico largo",
      "Una jeringa sin marcas de graduación"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Almacenar oxígeno puro al 100%",
      "Es para recolectar la saliva del paciente",
      "Sirve de contrapeso para que la mascarilla no se caiga"
    ],
    "c": 0,
    "e": "¡Correcto! A diferencia de la mascarilla simple, el reservorio se llena de oxígeno de forma continua. Cuando el paciente jala aire, recibe casi puro oxígeno del tanque, subiendo los niveles en sangre de golpe.",
  ...
  },
  {
    ...
    "o": [
      "Mide la temperatura por el oído",
      "Lanza un chorro de aire a alta presión que",
      "Extrae sangre de forma automática fuera de esta"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Se coloca en las venas grandes del cuello o",
      "Se pone en el dedo del pie cuando el caso es",
      "Es una aguja dental larga fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! Es un catéter premium. Al tener varios canales (lúmenes) independientes por dentro, permite pasar nutrición, medicamentos para la presión y sacar muestras de sangre a la vez sin que se mezclen.",
  ...
  },
  {
    ...
    "o": [
      "Coser huesos rotos de las rodillas",
      "Cirugías cardiovasculares, hernias y suturas",
      "Hacer vendajes de compresión húmedos"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "para limpieza general de superficies",
      "Para frenar hemorragias masivas en el esófago",
      "Para aspirar cera de los oídos de forma neumática"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Contiene Heparina de Litio o Sodio y se usa",
      "Contiene agua oxigenada para desinfectar las células",
      "Es un tubo seco sin ningún componente interno"
    ],
    "c": 0,
    "e": "¡Correcto! La heparina es un anticoagulante natural que frena la cascada de coagulación de inmediato. Permite al laboratorio obtener plasma limpio rápido tras centrifugar sin esperar a que la sangre se seque.",
  ...
  },
  {
    ...
    "o": [
      "Para fijar apósitos en zonas difíciles como",
      "Para amarrar cajas de cartón en la bodega",
      "Para hacer yesos rígidos de colores"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es una jeringa plástica grande con una escala",
      "Es una jeringa que trae un bulbo de hule o",
      "Una jeringa dental con agujas laterales"
    ],
    "c": 1,
    "e": "¡Correcto! La jeringa Asepto funciona por vacío manual al aplastar la pera de hule. Permite succionar suero estéril e irrigar heridas grandes para limpiarlas de restos mecánicos o suciedad.",
  ...
  },
  {
    ...
    "o": [
      "Pacientes con pieles sensibles, ancianos,",
      "Únicamente para pegar carteles informativos en las paredes de las clínicas",
      "Para tracciones óseas de alta resistencia"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Rollos de papel térmico para impresión",
      "Tiras reactivas específicas para la marca del glucómetro, las cuales absorben la gota de sangre por capilaridad",
      "Líquido limpiador de lentes ópticos fuera de esta"
    ],
    "c": 1,
    "e": "¡Correcto! El glucómetro es inservible sin sus tiras reactivas. Cada tira contiene una enzima química que reacciona con la glucosa de la sangre generando una micro-corriente eléctrica que la máquina traduce en un número.",
  ...
  },
  {
    ...
    "o": [
      "Es el diámetro más grueso disponible en el mercado, diseñado para reanimación extrema en traumas con pérdidas masivas de sangre",
      "Es el catéter más fino usado en prematuros",
      "Es una guía flexible larga para la nariz"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que se disuelve en 24 horas exactas",
      "Que es una sutura absorbible de larga",
      "Que está hecha de oro puro fuera de esta"
    ],
    "c": 1,
    "e": "¡Correcto! Mientras que el Vycril se absorbe rápido, el PDS aguanta el tirón durante meses. Es ideal para coser las capas más duras del abdomen que van a sufrir tensión por la tos o movimientos del paciente.",
  ...
  },
  {
    ...
    "o": [
      "Para derretir la comida con calor por corriente",
      "Para darle rigidez temporal al tubo de poliuretano",
      "Para amarrarla a la oreja del paciente"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que venga sellado individualmente en una bolsa",
      "Que sea de vidrio transparente pesado",
      "Que traiga agua destilada adentro para lavar"
    ],
    "c": 0,
    "e": "¡Correcto! Si el frasco viene suelto o destapado, pierde la esterilidad de inmediato por el polvo del aire. El empaque sellado le asegura al laboratorio que cualquier bacteria que crezca viene de la orina del paciente y no del frasco.",
  ...
  },
  {
    ...
    "o": [
      "Exactamente 20 gotas estándar",
      "60 microgotas finas",
      "Cinco gotas pesadas"
    ],
    "c": 0,
    "e": "¡Correcto! El normogotero es el equipo de batalla para adultos. Su calibración internacional dicta que 20 gotas de suero limpio equivalen a 1 ml de volumen pasados por la manguera.",
  ...
  },
  {
    ...
    "o": [
      "Filtra el agua del suero intravenoso",
      "Retiene el calor y la humedad del aire que",
      "Sirve para bloquear la voz del paciente"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Medir a una distancia muy lejana (más de 5cm)",
      "Pegar el sensor directo contra la piel humedecida",
      "Esperar 5 minutos a que la aguja suba"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "En clínicas estéticas para bótox",
      "En las salas de operaciones de cirugía mayor,",
      "Únicamente en consultas externas dentales"
    ],
    "c": 1,
    "e": "¡Correcto! El 16 gris es el segundo más grueso de la familia periférica. Es un insumo crítico de quirófano que permite bombear fluidos estables o sangre densa a velocidades súper rápidas.",
  ...
  },
  {
    ...
    "o": [
      "Que permite cerrar heridas largas de la piel",
      "Que las grapas se disuelven solas en el agua",
      "Que no causan ningún tipo de dolor al colocarse"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para meter aire continuo al cuerpo",
      "Para conectar un sistema de irrigación",
      "Es un canal de reserva por si se tapa la sonda"
    ],
    "c": 1,
    "e": "¡Correcto! La sonda Foley de 3 vías es la reina de la urología. Una vía infla el balón, otra drena la orina y la tercera mete suero continuo para mantener limpia la vejiga tras operaciones de próstata.",
  ...
  },
  {
    ...
    "o": [
      "Contiene Oxalato de Potasio y Fluoruro de Sodio",
      "Contiene alcohol destilado para hematología",
      "Trae geles de separación grasos gruesos"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Un termómetro digital para medir la fiebre en el oído",
      "El aparato completo para medir la presión",
      "Un monitor de ritmo cardíaco para atletas de alto rendimiento"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Mide al mismo tiempo la temperatura y la humedad del ambiente para asegurar que los productos no se arruinen",
      "Sirve para pesar con precisión milimétrica los polvos medicinales",
      "Es un tipo de cronómetro que mide el tiempo que"
    ],
    "c": 0,
    "e": "¡Correcto! Las normativas de salud exigen que los medicamentos se guarden a cierta temperatura y humedad para que no pierdan su efecto. El termohigrómetro es el encargado de vigilar que el ambiente no se ponga muy caliente ni muy húmedo.",
  ...
  },
  {
    ...
    "o": [
      "Permite escuchar el corazón de dos pacientes al mismo tiempo",
      "La campana grande es para escuchar sonidos de alta frecuencia (como",
      "Una campana funciona de forma digital y la otra es 100% analógica"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Que la aguja solo se puede usar en cirugías de corazón abierto",
      "Que está diseñada para atravesar la piel y aplicar medicamentos o",
      "Que la aguja se disuelve sola dentro del cuerpo"
    ],
    "c": 1,
    "e": "¡Correcto! 'Hipo' significa debajo y 'dermis' significa piel. Son las agujas tradicionales que se adaptan a las jeringas para inyectar directo al músculo o a la vena de forma rápida y segura.",
  ...
  },
  {
    ...
    "o": [
      "Sirve para limpiar las camillas después de una curación",
      "Está diseñado en rollos cilíndricos compactos",
      "Es un algodón especial que se usa para fabricar"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Refleja que contiene fibras sintéticas que",
      "Porque pasó por un proceso de desengrasado y purificación que le permite retener líquidos y desinfectar heridas sin causar alergias",
      "Porque cambia de color cuando entra en contacto"
    ],
    "c": 1,
    "e": "¡Correcto! El algodón en su estado natural trae aceites y ceras de la planta que repelen el agua. Para uso médico se procesa para dejarlo totalmente puro e hidrófilo (que ama el agua), haciéndolo súper absorbente para curaciones.",
  ...
  },
  {
    ...
    "o": [
      ...
      "Porque la pipeta automática no tiene fuerza y la punta de plástico sirve para romper los frascos de vidrio",
      "Porque las puntas de plástico contienen"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que puede succionar hasta 10 litros de líquido",
      "Que mide y dosifica volúmenes microscópicos",
      "Que calienta los líquidos automáticamente"
    ],
    "c": 1,
    "e": "¡Correcto! Con una pipeta tradicional de vidrio tenías que andar midiendo al ojo o usando bulbos de hule. La pipeta automática tiene un sistema calibrado por resortes internos que saca la cantidad exacta de líquido una y otra vez sin margen de error humano.",
  ...
  },
  {
    ...
    "o": [
      "Se usa para limpiar la nariz y las orejas del recién nacido",
      "Es una pinza plástica con dientes de seguridad que",
      "Sirve para sujetar la tarjeta de identificación"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Es la capa acolchada que se coloca",
      "Es una venda adhesiva que se usa para tapar los ojos en cirugías",
      "Se usa para amarrar las camillas de transporte"
    ],
    "c": 0,
    "e": "¡Correcto! El yeso médico al secarse se calienta un tazón y se vuelve una piedra rígida que puede romper la piel. La guata funciona como un colchón suave y protector que absorbe el sudor y evita que el yeso lastime al paciente.",
  ...
  },
  {
    ...
    "o": [
      "Sirve únicamente para sostener apósitos llenos de pomada",
      "Para dar soporte firme a articulaciones",
      "Se usa para tapar heridas abiertas que están"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Porque su estructura tejida y abierta permite",
      "Porque tiene un químico especial que duerme el dolor de la carne viva",
      "Porque es completamente impermeable y no deja"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Que el plástico corta mejor la piel que el metal común",
      "Que viene la hoja integrada al mango lista",
      "Que el bisturí desechable se puede afilar con una piedra común en medio de la cirugía"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Sirve para colgar la ropa y los sacos de los médicos en el consultorio",
      "Es el soporte vertical diseñado para colgar",
      "Es una base para colocar los monitores de computadoras en la recepción"
    ],
    "c": 1,
    "e": "¡Correcto! El atril (o porta suero) mantiene las soluciones elevadas por encima del brazo del paciente. Al estar alto, la presión de la gravedad empuja el líquido hacia abajo a través del tubo del venoclisis de forma continua.",
  ...
  },
  {
    ...
    "o": [
      "Que está hecha de plástico inflable para emergencias en el agua",
      "Que es más angosta, ligera, con parachoques",
      "Que no tiene colchón porque los pacientes de traslado deben viajar completamente rígidos"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Se pega en la cabeza para recolectar fluidos nasales",
      "Se adhiere al abdomen del paciente alrededor",
      "Se conecta a las venas del brazo con un catéter"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Permite inyectar medicamentos a la manguera",
      "Sirve para enfriar el suero líquido",
      "Es un tapón de madera rústico fuera de esta"
    ],
    "c": 0,
    "e": "¡Correcto! Antes se pinchaban las mangueras con agujas desnudas para meter medicinas, rompiendo el plástico y causando pinchazos accidentales. El sistema libre de aguja sella por presión de forma estéril.",
  ...
  },
  {
    ...
    "o": [
      "para limpieza general de superficies",
      "Para hacer ejercicios de inhalación profunda",
      "Para entrenar la fuerza de los dedos"
    ],
    "c": 1,
  ...
  },
  {
    ...
    "o": [
      "Retira la aguja de metal y la encierra de forma",
      "Inyecta anestesia local en la piel sola",
      "Cambia el color del catéter de rosado a verde"
    ],
    "c": 0,
    "e": "¡Correcto! Los catéteres modernos de seguridad protegen al personal de enfermería. Al sacar la guía metálica de la vena, el escudo salta y bloquea la punta con sangre reduciendo a cero los accidentes laborales.",
  ...
  },
  {
    ...
    "o": [
      "El Catgut Simple es digerido por el cuerpo de forma",
      "El simple dura un año entero sin deshacerse",
      "El simple está hecho de plástico rígido azul"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es un tubo corto y flexible de plástico",
      "Es una manguera gruesa para el cuello",
      "Se usa para medir la audición fuera de esta"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Bancos de sangre para pruebas de paternidad,",
      "Hacer exámenes de orina completa cuando el caso es",
      "Medir los niveles de grasa en la orina"
    ],
    "c": 0,
    "e": "¡Correcto! El aditivo ACD conserva los glóbulos rojos vivos y estables por semanas y protege la estructura de los ácidos nucleicos (ADN). Es un tubo premium de genética y alta especialidad.",
  ...
  },
  {
    ...
    "o": [
      "Es muchísimo más ligera, resistente al agua,",
      "Que es transparente como el vidrio de una ventana",
      "Que se estira como banda elástica de gimnasio"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Es un gorro impregnado con champú y acondicionador",
      "Es un casco de metal pesado para masajes",
      "Un gorro plástico común para no mojarse el pelo"
    ],
    "c": 0,
    "e": "¡Correcto! Es una bendición para pacientes en cuidados intensivos o post-operados de columna que no pueden moverse de la cama. Limpia, desinfecta y refresca la cabeza en dos minutos sin mojar las sábanas.",
  ...
  },
  {
    ...
    "o": [
      "Aplicación de inyecciones intramusculares en adultos",
      "Pinchazos superficiales en la piel de la cara",
      "Extracción de líquido de los oídos de recién nacidos"
    ],
    "c": 0,
  ...
  },
  {
    ...
    "o": [
      "Para cerrar el catéter venoso en el brazo del paciente",
      "para control de temperatura ambiental",
      "Para trancar las mangueras de oxígeno de los tanques"
    ],
    "c": 0,
    "e": "¡Correcto! El tapón amarillo se enrosca en el catéter. Trae una membrana de hule al centro que permite a la enfermera inyectar ampolletas con una jeringa a cualquier hora y se sella sola al retirar la aguja.",
